...
const _CONFIG = (
	{
		...
		EntrypointInputSourceFile: `${__dirname}/source/Quantifier-Browser-Shim.js`,
		...
		LibraryUniminifiedFileName: `quantifier.js`,

		// The name of the minified version of the packaged library, for production release:
		LibraryMinifiedFileName: `quantifier.min.js`
	});
