...
var QuantifierSettings = function ()
{
	var constructSettings = function()
	{
		var tmpSettings = libUnderscore.extend({},
		{
	...
	return {construct: constructSettings};
};

module.exports = new QuantifierSettings();